...
export default function AdminLoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (result.success) {
        // Session token'ı localStorage'a kaydet (backup için)
          ...
          <CardHeader className="text-center space-y-4">
            ...
            <div>
              ...
              <CardDescription className="text-gray-400">
                RDHN Commerce yönetim sistemine giriş yapın
              </CardDescription>
            </div>
          </CardHeader>
        ...
        <Card className="mt-4 border-gray-700 bg-gray-800/30 backdrop-blur-sm">
          <CardContent className="pt-6">
            <div className="text-center space-y-2">
              <p className="text-amber-400 text-sm font-medium">🔒 Güvenli Giriş</p>
              <p className="text-gray-300 text-xs">
                Giriş bilgilerinizi kimseyle paylaşmayın ve güçlü şifreler kullanın.
              </p>
            </div>
          </CardContent>
        </Card>
